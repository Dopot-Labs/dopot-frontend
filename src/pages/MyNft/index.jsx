              ...
              <div className="pts-right">
                <div className="pts-right-grid">
                  ...
                  <div className="pts-right-grid-card">
                    <Link
                      href={
                        "https://app.aragon.org/dao/arbitrum-mainnet/0x8115CF635A71FE591B9c74d706a6d028ba44A776/dashboard"
                      }
                      target="_blank"
                      rel="noreferrer"
                    >
                  ...
                  investedCard.map((card, index) => (
                    <div key={index} className="pmg-right-card-nft">
                      ...
                      <div className="pc-hero-icon-grid"></div>
                        ...
                        <div
                          className="dropdown-container d-flex"
                          tabindex="-1"
                        >
                          ...
                          <div className="dropdown">
                            ...
                            <Link
                              href={""}
                              onClick={() =>
                                refundNft(card.project, card.tokenId, t)
                              }
                            >
                              <div>Refund</div>
                            </Link>
