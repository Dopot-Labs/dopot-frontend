...
//             counter += 1
//             let investor = event.returnValues.investor;
//             let projectAddress = event.returnValues.project;
//             const tokenId = event.returnValues.tokenId;
//             let rewardBalance = (await dopotReward.balanceOf(investor, tokenId)).toNumber();
//             let objectInsert = {
//                 address: investor,
//                 tokenId,
...
//         console.log("After log again ======================", projdb)
...
async function getInvestors(projdb, dopotReward) {
    try {
        ...
        for (const event of events) {
            ...
            try {
                const rewardBalance = (await dopotReward.balanceOf(investor, tokenId)).toNumber();
                console.log("🚀 ~ events.forEach ~ rewardBalance:", rewardBalance);
        ...
        console.log("🚀 ~ getInvestors ~ error retrieving events:", error);
    }
}
